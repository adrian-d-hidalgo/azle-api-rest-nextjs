 ...
 * 
 * @param {Uint8Array | number[]} body The data to be converted, which can be either a Uint8Array or an array of numbers.
 ...
 */
export function parseBodyResponse(body: Uint8Array | number[]): any {
    ...
    if (Array.isArray(body) && body.every(element => typeof element === 'number')) {
        return body;
    }
